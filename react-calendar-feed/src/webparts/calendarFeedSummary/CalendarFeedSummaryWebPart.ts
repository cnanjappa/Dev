...
export default class CalendarFeedSummaryWebPart extends BaseClientSideWebPart<ICalendarFeedSummaryWebPartProps> {
          ...
          groups: [
            {
              ...
              groupFields: [
                ...
                PropertyPaneTextField("navigationUrl", {                 
                  label: strings.NavigationUrlFieldLabel,      
                  value: navigationUrl                     
                }),                
                
                PropertyPaneTextField("archiveUrl", {                 
                  label: strings.ArchiveUrlFieldLabel,      
                  value: archiveUrl                     
                }),  
  ...
  private _getDataProvider(): ICalendarService {
    ...
    provider.NavigationUrl = navigationUrl;
    provider.ArchiveUrl = archiveUrl;
