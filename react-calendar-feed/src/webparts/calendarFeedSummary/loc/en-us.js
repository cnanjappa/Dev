define([], function() {
  return {
    ...
    NavigationUrlFieldLabel: "Navigation URL",
    ArchiveUrlFieldLabel: "Archive URL",
    ...
    NavigationUrlValidationNoUrl: "Provide a URL",
    NavigationUrlValidationInvalidFormat: "URL is not a valid format. Please use a URL that starts with http:// or https://. ",
    ...
    LocalizedTimeFormat: "ddd, MMM DD, h:mm A [(ET)]",//"llll",
